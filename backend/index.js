...
app.get("/", (req, res) => {
  let saludo = {
    Saludo: "Hola mundo!",
    infoAdicional: "Este es un ejemplo de un endpoint en un backend",
  };
  res.json(saludo);
});
...
app.get("/students/:carnet", (req, res) => {
  ...
  const carnet = parseInt(req.params.carnet, 10); //Convertimos el carnet a entero
...
app.post("/students", (req, res) => {
  ...
  // Actualizamos el archivo con los nuevos datos
  updateDataFile();
